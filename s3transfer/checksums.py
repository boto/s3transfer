...
_CRC_COMBINE_FUNCTIONS = {
    'crc32': CrcCombineInfo(combine_crc32, 4),
}

if HAS_CRT:
    from awscrt import checksums as crt_checksums

    # Prefer the CRT combine implementations when available.
    _CRC_COMBINE_FUNCTIONS.update(
        {
...
def is_full_object_checksum_supported(algorithm):
    return algorithm in _CRC_COMBINE_FUNCTIONS
